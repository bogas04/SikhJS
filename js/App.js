...
import ReactRouter, { Router, Route, IndexRoute, Link, hashHistory } from 'react-router';
...
render((
  <Router history={hashHistory} onUpdate={() => { console.log(window); window.scrollTo(0, 0)}}>
